...
describe('Formula1Driver', function () {
  let owner: SignerWithAddress, user: SignerWithAddress, formula1Token: Formula1Token, formula1Driver: Formula1Driver
  ...
  beforeEach('deploy ERC721 token', async () => {
    ...
    formula1Driver = await Formula1Driver.deploy(await formula1Token.getAddress())
  })
