...
const upgradeModule = buildModule('UpgradeModule', (m: IgnitionModuleBuilder) => {
  ...
  const formula1Race = m.contract('Formula1RaceV2');
  ...
  m.call(proxyAdmin, 'upgradeAndCall', [proxy, formula1Race, '0x'], {
 ...
 */
export const Formula1RaceUpgradeV2 = buildModule('Formula1RaceUpgradeV3', (m) => {
...
export default Formula1RaceUpgradeV2;
